...
from kastredux.core import __version__
...
project = u'KAST Optical Spectral Reduction Toolkit'
copyright = u'2019-2020, Adam Burgasser'
...
htmlhelp_basename = 'kastreduxdoc'
...
latex_documents = [
  (master_doc, 'kastredux.tex', u'KASTRedux Documentation',
   u'Adam Burgasser', 'manual'),
]
...
man_pages = [
    (master_doc, 'kastredux', u'KASTRedux Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'kastredux', u'KASTRedux Documentation',
   author, 'KASTRedux', 'Spectral Reduction Package for Lick/KAST.',
   'Miscellaneous'),
]
